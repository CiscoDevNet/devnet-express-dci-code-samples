...
spark_room_title = 'YOUR EVENT ROOM NAME'
spark_message = 'YOUR MESSAGE'
#spark_message = 'I have completed the Programming Cisco Compute - Python Mission'

if spark_api_token == 'YOUR TOKEN' or spark_room_title == 'YOUR EVENT ROOM NAME' or spark_message == 'YOUR MESSAGE':
...
for room in resp["items"]:
     if room["title"] == spark_room_title:
